...
// import Sidebar from "../../components/Sidebar";      // ✅ Admin-style sidebar
// import Header from "../../components/Header";        // ✅ Admin-style header
// import "../../styles/profile.css";                   // ✅ Custom student profile styling

// const Profile = () => {
//   const [formData, setFormData] = useState({
//     fullName: "Vishal Jadhav",
//     mobile: "+91 1234567890",
//     email: "vishaljadhav@gmail.com",
//     dob: "",
//     country: "",
//     city: "",
//     about: "",
...
import profilePic from "../../assets/student profile.png"; // Student fallback asset
...
const StudentProfile = () => {
  ...
  // Load Student Profile from backend API
  useEffect(() => {
    let mounted = true;
    fetchMyProfile()
      .then((data) => {
      ...
      <div className="main-content-wrapper flex-grow-1">
        ...
        <div className="container py-4" style={{ maxWidth: "860px" }}>
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div>
              <h4 className="fw-bold m-0 page-title">Student Profile Detail</h4>
              <p className="text-muted small m-0">Manage your student details, contact info, and profile avatar</p>
            </div>
          </div>
          ...
          <div className="profile-card shadow-sm">
            ...
            <div className="profile-avatar-section">
              <div className="avatar-wrapper">
                <img src={preview} alt="Student Profile" className="profile-img" />
                <label htmlFor="student-image-upload" className="camera-overlay-btn" title="Change Profile Photo">
              ...
              <h6 className="fw-bold mt-1 mb-0">{formData.full_name || "Student"}</h6>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  name="about"
                  rows="3"
                  placeholder="Tell us about your learning goals or interests..."
                  value={formData.about || ""}
                  onChange={handleChange}
                />
              </div>
